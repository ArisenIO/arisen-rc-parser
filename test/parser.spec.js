...
describe('parser', () => {
    ...
    it('should be able to parse the bidname action', () => {
        testAction('bidname', {bid: '3 RSN', bidder: 'testaccount', newname: 'somename'}, 'testaccount');
    });

    it('should be able to parse the bidname action with html enabled', () => {
        const parsed =testAction('bidname', {bid: '3 RSN', bidder: 'testaccount', newname: 'somename'}, 'testaccount', true);
    ...
    it('should be able to parse the bidname action with html enabled and custom tags', () => {
        const parsed = testAction('bidname', {bid: '3 RSN', bidder: 'testaccount', newname: 'somename'}, 'testaccount', {h1:'b', h2:'i class="test"'});
